...
class SuccessPassCreation: UIViewController {
    ...
    let subHead: UILabel = {
        let label = UILabel()
        label.text = "Password changed successfully, you can login again with a new password"
